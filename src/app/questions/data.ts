...
},
{
    ...
    answers: ['tune2fs -d 200 /dev/sda1', 'tune2fs -i 200 /dev/sda1', 'tune2fs -c 200 /dev/sda1', 'tune2fs -n 200 /dev/sda1', 'tune2fs --days 200 /dev/sda1'],
    type: 'single',
